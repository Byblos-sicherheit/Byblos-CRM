...
description: Apply a disciplined, cross-functional software-engineering workflow to programming tasks and technology decisions of any size. Use for requirements analysis, architecture, technology selection, executive adoption cases, vendor evaluation, leadership pitches, new projects, feature implementation, debugging, refactoring, code review, testing, security assessment, performance work, database design, API integration, DevOps, deployment, migration, documentation, or delivery of runnable project files. Supports Arabic, English, German, and bilingual output; uses available repository, terminal, web, documentation, connector, and testing tools when relevant.
---
...
- Build an executive technology-adoption case, vendor evaluation, leadership memo, or closing argument
...
### 9. Build executive technology-adoption cases

For leadership pitches, vendor evaluations, investment cases, board narratives, or closing arguments:

1. Load `references/executive-technology-adoption.md`.
2. Verify current product capabilities and commercial or compatibility claims using official sources.
3. Build a causal argument from the changed operating environment to the bottleneck, capability, mechanism, measurable outcome, risk, and recommended decision.
4. Separate verified product capability, vendor-reported evidence, organization-specific inference, and proposed measurement.
5. Do not invent ROI figures. When internal baselines are absent, provide a formula, required inputs, and a pilot measurement plan.
6. Load `references/executive-pilot-roi.md` when the recommendation requires financial approval or a measurable pilot.
7. Load `references/executive-objection-handling.md` before a high-stakes recommendation and answer the strongest realistic objections.
8. Use `scripts/executive_roi_model.py` only with user-provided or explicitly modeled inputs; never fill missing values silently.
9. Use `scripts/pilot_scorecard.py` only after weights, gates, and thresholds are declared before results are scored.
10. When Develocity is the subject, also load `references/develocity-adoption-case.md` and `references/develocity-decision-pack.md`; use `references/develocity-executive-pitch-example.md` only as a structural example and refresh every factual claim.
11. Consult the dated snapshot only to accelerate research, then recheck the live official sources.

### 10. Deliver using an evidence-based contract
...
- Executive adoption and leadership cases: `references/executive-technology-adoption.md`
- Pilot design and ROI discipline: `references/executive-pilot-roi.md`
- Executive objection handling and red-team review: `references/executive-objection-handling.md`
- Develocity-specific evaluation and causal model: `references/develocity-adoption-case.md`
- Develocity approval, pilot, and scorecard pack: `references/develocity-decision-pack.md`
- Dated Develocity research snapshot: `references/develocity-current-snapshot-2026-07-27.md`
- Worked Develocity pitch structure: `references/develocity-executive-pitch-example.md`
- Reusable Develocity decision memo: `assets/develocity-executive-decision-memo.md`
- Develocity pilot scorecard CSV: `assets/develocity-pilot-scorecard.csv`
- Repository inventory script: `scripts/project_inventory.py`
- Executive ROI calculator: `scripts/executive_roi_model.py`
- Preweighted pilot scorecard evaluator: `scripts/pilot_scorecard.py`
